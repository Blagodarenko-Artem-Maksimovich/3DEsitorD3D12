...
// PSOutput ñ íåñêîëüêèìè áóôåðàìè
struct PSOutput
{
    float4 Albedo : SV_Target0; // Diffuse color
    float4 Normal : SV_Target1; // Normal.xyz, alpha ìîæíî çàäàòü =1
...
{
    PSOutput outt;
    // Ñýìïëèì äèôôóçíóþ òåêñòóðó
    float4 diffuseTex = gDiffuseMap.Sample(gsamAnisotropicWrap, pin.TexC);
    outt.Albedo = diffuseTex * gDiffuseAlbedo; // àëüáåäî (RGB), àëüôà ìîæåì âçÿòü èç diffuseAlbedo.a

    // Îáðàáàòûâàåì íîðìàëü: èç êàðòû èëè âåðøèííàÿ
    float3 normalW;
    // Ñýìïëèðóåì êàðòó íîðìàëåé â íåëèêâèäíîì ïðîñòðàíñòâå (0..1 -> -1..1)
